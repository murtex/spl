...
images:
	#cd matlab/digital; matlab -nosplash -nodesktop -r "sampling; print( fig1, '../../images/sampling_ad', '-depsc2', '-loose' ); print( fig2, '../../images/sampling_da', '-depsc2', '-loose' ); exit();"
	#cd matlab/digital; matlab -nosplash -nodesktop -r "decibel; print( fig1, '../../images/linear', '-depsc2', '-loose' ); print( fig2, '../../images/decibel', '-depsc2', '-loose' ); exit();"
	#cd matlab/digital; matlab -nosplash -nodesktop -r "fdomain; print( fig1, '../../images/fdomain_decomp', '-depsc2', '-loose' ); print( fig2, '../../images/fdomain_powspec', '-depsc2', '-loose' ); exit();"
	#cd matlab/digital; matlab -nosplash -nodesktop -r "spectrum; print( fig1, '../../images/spectd', '-depsc2', '-loose' ); print( fig2, '../../images/specfd', '-depsc2', '-loose' ); exit();"
