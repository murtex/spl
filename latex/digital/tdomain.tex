...
\begin{frame} % -------------------------------------------------------------
	\frametitle{Time domain}
	\begin{itemize}
		\item \textbf{example (\sound[automute, inlinesound, samplingrate=44100, bitspersample=16, channels=1, encoding=Signed, externalviewer]{playback}{matlab/sound.wav})}: \texttt{matlab/decibel.m} 
			\begin{align*}
